  ...
  return (
    <>
      ...
      <main id="main" className="wrap desktop-page">
        ...
        <p>In return for premium features of AFKMAXX, you may choose to be a peer on the Bright Data network. By doing so, you agree to have read and accepted the <a href="https://bright-sdk.com/eula">Bright SDK EULA</a> and <a href="https://bright-sdk.com/privacy-policy">Bright Data’s Privacy Policy</a>.</p>
        <p>You may opt out of the Bright Data network by turning off Web Indexing in the AFKMAXX desktop app (the Web Indexing switch in the Mac or Windows window, or in the Mac menu bar).</p>
